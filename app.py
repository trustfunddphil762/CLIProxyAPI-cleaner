...
def application(environ, start_response):
    ...
    try:
        if path in ('/proxy-cleaner', '/proxy-cleaner/'):
        ...
        if path == '/proxy-cleaner/styles.css':
